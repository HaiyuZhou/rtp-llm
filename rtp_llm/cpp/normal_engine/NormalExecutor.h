...
public:
    ...
    // Offline-only: caller owns cache initialization and synchronization. No sampler/dispatch.
    void replayBatch(const std::list<GenerateStreamPtr>& streams, int64_t source_execution_id);

...
<span>全部 batch：Compute / Cache / Batch；单个 batch：Compute / Cache / TTFT。颜色始终表示 TTFT。</span>
...
function draw(){
 ...
 const color=data.map(r=>r.median_batch_ttft_ms),title='整批 TTFT 中位数 (ms)';
